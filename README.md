...
:white_check_mark:**Front_TCP:** Used for the gripping process and approaching the pen rack.

:white_check_mark:**Pen_TCP:** The primary drawing tool, calibrated to the tip of the pen (300mm length).
